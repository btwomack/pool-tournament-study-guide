...
export const TournamentView: React.FC = () => {
  ...
  const isAdmin = localStorage.getItem('userId') === tournament.createdBy.id;
  ...
  return (
    <div className="min-h-screen bg-pool-felt text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <CalcuttaPanel tournamentId={tournament.id} players={players} />
        </div>
        ...
        {selectedMatch && isAdmin && (
          <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-pool-table p-8 rounded-lg shadow-xl w-full max-w-md">
              ...
              <MatchupPreview matchId={selectedMatch.id} />
              <form onSubmit={(e) => { e.preventDefault(); handleRecordResult(); }} className="space-y-4 mt-4">
                <div>
